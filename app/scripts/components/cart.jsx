...
var StripeButton = require('./stripebutton.jsx');
  ...
  render: function(){
    return (
      <div>
        ...
        <div className="container">Use Credit Card #4242 4242 4242 4242 with any expiration date in the future and 3 digit CVV to do a test checkout</div>
      </div>
    );
  }
})
